...
export default function HeroHeader() {
  return (
    <header className="flex gradient-background bg-gradient-to-tr from-primary-blue to-slate-500 dark:from-slate-800 dark:to-primary-blue backdrop-blur-3xl  text-neutral-light">
